...
class _FinalItineraryMapScreenState extends State<FinalItineraryMapScreen> {
  ...
  List<Marker> get _kakaoMarkers => [
        Marker(
          markerId: 'cafe_bora',
          latLng: LatLng(37.5546, 126.9240),
          infoWindowContent:
              '<div style="padding:4px 8px;font-size:12px;font-weight:bold;">Cafe Bora</div>',
        ),
        Marker(
          markerId: 'blue_bottle',
          latLng: LatLng(37.5443, 127.0557),
          infoWindowContent:
              '<div style="padding:4px 8px;font-size:12px;font-weight:bold;">Blue Bottle Seongsu</div>',
        ),
        Marker(
          markerId: 'changdeokgung',
          latLng: LatLng(37.5794, 126.9910),
          infoWindowContent:
              '<div style="padding:4px 8px;font-size:12px;font-weight:bold;">Changdeokgung</div>',
        ),
      ];
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    // KakaoMap — Android/iOS: 실제 지도, Web: 플레이스홀더
                    SizedBox(
                      height: 240,
                      child: kIsWeb
                          ? _WebMapPlaceholder()
              ...
              child: Column(children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: kMint.withOpacity(0.35), blurRadius: 8, offset: const Offset(0, 3))],
                  ),
...
class _GridPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final p = Paint()..color = Colors.white.withOpacity(0.4)..strokeWidth = 0.8;
